...
$ui-checkbox-border-width           : get-size(2px) !default;
$ui-checkbox-checkmark-width        : get-size(2px) !default;
$ui-checkbox-transition-duration    : 0.15s !default;
$ui-checkbox-label-font-size        : get-size(16px) !default;

$ui-checkbox-size                   : get-size(20px); // no !default as it shouldn't be overridden
