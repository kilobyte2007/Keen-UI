...
$ui-toolbar-font-size   : get-size(18px) !default;
$ui-toolbar-height      : get-size(56px) !default;
...
.ui-toolbar {
    ...
    &:not(.is-raised).ui-toolbar--type-default {
        border-bottom: get-size(1px) solid $divider-color;
    }

    .ui-icon-button {
        height: get-size(48px);
        width: get-size(48px);
    }
}
...
.ui-toolbar__body {
    ...
    &.has-brand-divider {
        ...
        border-left-width: get-size(1px);
