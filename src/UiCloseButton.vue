...
$ui-close-button-size            : get-size(36px) !default;
$ui-close-button--size-mini      : get-size(24px) !default;
$ui-close-button--size-small     : get-size(32px) !default;
$ui-close-button--size-large     : get-size(48px) !default;
